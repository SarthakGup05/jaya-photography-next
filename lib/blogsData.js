...
export const FALLBACK_BLOGS = [
  {
    _id: "blog-maternity-lucknow",
    id: "blog-maternity-lucknow",
    slug: "maternity-photoshoot-in-lucknow",
    title: "Maternity Photoshoot in Lucknow: A Complete Guide for Expecting Mothers",
    metaTitle: "Maternity Photoshoot in Lucknow | Complete Guide",
    metaDescription: "Planning a maternity photoshoot in Lucknow? Discover the best time, outfits, poses, ideas, styling, preparation tips and how to choose the right maternity photographer.",
    metaKeywords: ["maternity photoshoot in lucknow", "maternity photographer lucknow", "pregnancy photoshoot lucknow", "best maternity photographer lucknow", "maternity photoshoot outfit styling", "pregnancy poses tips"],
    subtitle: "Discover the best time, outfits, poses, ideas, styling, preparation tips and how to choose the right maternity photographer in Lucknow.",
    ...
    excerpt: "Planning a maternity photoshoot in Lucknow? Discover the best time, outfits, poses, ideas, styling, preparation tips and how to choose the right maternity photographer.",
    content: `
      <h2>Celebrating Motherhood with Timeless Style & Grace</h2>
      <p>Maternity photography captures the radiant beauty, expectation, and profound bond of motherhood. Here is how to select outfits, plan poses, and choose the right maternity photographer in Lucknow.</p>
      
      <h3>1. Ideal Timing for your Maternity Photoshoot</h3>
      <p>The sweet spot for scheduling your maternity session is between 28 and 34 weeks of pregnancy. During this timeframe, your baby bump is beautifully rounded, and you will still feel comfortable moving and posing.</p>
      
      <h3>2. Empire Waist & Flowing Fabrics</h3>
      <p>Flowing gowns made of chiffon, tulle, or silk accentuate your bump effortlessly while adding movement and romance to your portraits.</p>
      
      <h3>3. Color Palettes that Shine</h3>
      ...
      <h3>4. Outdoor vs. Indoor Studio Session in Lucknow</h3>
      <p>Our luxury studio offers temperature-controlled, private mother & baby lounge comfort. For outdoor lovers, Lucknow offers scenic heritage and lush greenery backdrops.</p>
    `,
    date: "Sep 15, 2025",
    readTime: "6 min read",
    author: {
  ...
  },
  {
    ...
    metaTitle: "Newborn Photography Session Preparation Guide | Jaya Photography",
    metaDescription: "A complete parent checklist for timing, feeding, studio warmth, props, and stress-free newborn portraits in Lucknow.",
    metaKeywords: ["newborn photography lucknow", "newborn photoshoot guide", "baby photography tips"],
    ...
    content: `
      ...
      <ul>
        ...
        <li><strong>Studio Climate:</strong> Our Lucknow studio is maintained at a soothing 26°C–28°C.</li>
      ...
      <p>Our luxury studio in Lucknow is heated to a cozy 26°C to 28°C to ensure your baby stays warm and relaxed even without heavy swaddles. Parents are encouraged to dress in light, breathable clothing.</p>
  ...
  },
  {
    ...
    metaTitle: "Maternity Photoshoot Outfit & Styling Tips | Jaya Photography",
    metaDescription: "Style advice, color pairings, gown silhouettes, and location ideas that highlight your pregnancy glow.",
    metaKeywords: ["maternity outfit tips", "maternity dresses lucknow", "pregnancy styling"],
